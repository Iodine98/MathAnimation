...
class PUnion(Scene):
    ...
    def construct(self):
        ...
        vertical_group_1 = self.create_vertical_group_one(first_line_eq, second_line_eq)
        vertical_group_2 = self.create_vertical_group_two(first_line_eq, third_line_eq)
        self.add(vertical_group_1)
        self.wait(2)
